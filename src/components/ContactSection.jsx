...
//             <h3 className="text-4xl md:text-5xl font-bold text-white mb-8">Let’s Start a <br/><span className="text-gold italic">Conversation.</span></h3>
            
//             <div className="space-y-8 mt-12">
//               {[
//                 { icon: <Phone className="text-gold" />, label: "Call Us", value: "+33 7 50 30 29 10" },
//                 { icon: <Mail className="text-gold" />, label: "Email Us", value: "cosmicmotherofficial@gmail.com" },
//                 { icon: <MapPin className="text-gold" />, label: "Visit Us", value: "15 Boulevard Maxime Gorki, 93240 Stains, France 🇫🇷" },
//               ].map((item, i) => (
...
//                   className="w-10 h-10 rounded-lg border border-white/10 flex items-center justify-center text-white/60 hover:border-gold transition-all"
//                 >
//                   <Icon size={20} />
//                 </motion.a>
//               ))}
...
//                   className="bg-white/5 border border-white/10 rounded-xl px-6 py-4 text-white placeholder-gray-500 focus:border-gold outline-none transition-all"
//                   required
//                 />
//                 <input
//                   type="text"
...
//                   onChange={handleChange}
//                   className="bg-white/5 border border-white/10 rounded-xl px-6 py-4 text-white placeholder-gray-500 focus:border-gold outline-none transition-all md:col-span-2"
//                   required
//                 />
//                 <textarea
//                   name="message"
...
//                   <button
//                     type="submit"
//                     className="w-full bg-gold hover:bg-gold-hover text-navy font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-3 shadow-lg shadow-gold/20"
//                   >
