...
// import raffleTicket from "../assets/images/ticket.jpg"; // Ensure path is correct

// export default function RaffleSection({ onDonateClick }) {
//   return (
...
//               *Winners will be contacted via email/phone provided during donation.
//             </p>
//           </div>
