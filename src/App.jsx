...
export default function App() {
  ...
  // These functions control the global DonationModal
  const openDonate = () => setIsDonateOpen(true);
  const closeDonate = () => setIsDonateOpen(false);

  return (
    <div className="bg-white font-sans selection:bg-gold selection:text-navy">
      {/* Navbar uses the global trigger */}
      <Navbar onDonateClick={openDonate} t={navContent} />
      ...
      <main>
        ...
        <section id="projects">
          {/* UPDATED: We pass openDonate to Projects so the Atampinting button works */}
          <Projects onDonateClick={openDonate} />
        </section>
      ...
      {/* This is the single source of truth for your Payment Details */}
      <DonationModal isOpen={isDonateOpen} onClose={closeDonate} />
    </div>
  );
}